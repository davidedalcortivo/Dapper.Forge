...
namespace Dapper.Forge.MySql.Extensions
{
    public static partial class DbConnectionExtensions
    {
        ...
        public static DbCommandInfo GetAllCommand<TEntity>(this MySqlConnection connection, IFilterNode<TEntity> filterNode, IEnumerable<SortDescriptor>? sortDescriptors = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo GetFirstCommand<TEntity>(this MySqlConnection connection, IFilterNode<TEntity> filterNode, IEnumerable<SortDescriptor>? sortDescriptors = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo GetFirstOrDefaultCommand<TEntity>(this MySqlConnection connection, IFilterNode<TEntity> filterNode, IEnumerable<SortDescriptor>? sortDescriptors = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo GetPageCommand<TEntity>(this MySqlConnection connection, IFilterNode<TEntity> filterNode, IEnumerable<SortDescriptor>? sortDescriptors = null, int? skip = null, int? take = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo UpdateCommand<TEntity>(this MySqlConnection connection, object param, IFilterNode<TEntity> filterNode) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo MinCommand<TEntity>(this MySqlConnection connection, string propertyName, IFilterNode<TEntity> filterNode) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        public static DbCommandInfo MaxCommand<TEntity>(this MySqlConnection connection, string propertyName, IFilterNode<TEntity> filterNode) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
