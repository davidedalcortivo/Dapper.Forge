"""Reads a Cobertura XML report and prints the Dapper.Forge.Core package's line coverage as GitHub Actions
...
package = root.find(".//package[@name='Dapper.Forge.Core']")

if package is None:
    sys.exit("Dapper.Forge.Core package not found in coverage report")
