"""Reads a Cobertura XML report and prints the DapperForge.Core package's line coverage as GitHub Actions
...
package = root.find(".//package[@name='DapperForge.Core']")

if package is None:
    sys.exit("DapperForge.Core package not found in coverage report")
