...
namespace Dapper.Forge.SqlServer.Extensions
{
    public static partial class DbConnectionExtensions
    {
        ...
        public static void LoadRuntimeCache<TEntity>(this SqlConnection connection) where TEntity : class
        {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="connection"/> is <see langword="null"/>.</exception>
        public static DbCommandInfo GetAllCommand<TEntity>(this SqlConnection connection, IEnumerable<SortDescriptor<TEntity>>? sortDescriptors = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException"><paramref name="connection"/> is <see langword="null"/>.</exception>
        public static DbCommandInfo GetFirstOrDefaultCommand<TEntity>(this SqlConnection connection, IEnumerable<SortDescriptor<TEntity>>? sortDescriptors = null) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        /// <paramref name="predicate"/> uses an expression shape that the SQL translator does not support.
        /// </exception>
        public static DbCommandInfo UpdateCommand<TEntity>(this SqlConnection connection, object values, Expression<Func<TEntity, bool>>? predicate) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        /// translator does not know how to translate it.
        /// </exception>
        public static DbCommandInfo UpdateCommand<TEntity>(this SqlConnection connection, object values, IFilterNode<TEntity>? filterNode) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
        ...
        /// does not provide this if the two statements are sent independently or auto-committed separately. The
        /// corresponding <see cref="Upsert{TEntity}(SqlConnection, TEntity, SqlTransaction?, int?)"/> execution
        /// method provides this by wrapping the command in a transaction it manages; code that executes this
        /// command directly is responsible for doing the same.
        /// </para>
        /// </remarks>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="connection"/> or <paramref name="entity"/> is <see langword="null"/>.
        ...
        /// </exception>
        /// <exception cref="ArgumentException"><paramref name="selector"/> does not select a simple property.</exception>
        public static DbCommandInfo MinCommand<TEntity, TProperty>(this SqlConnection connection, Expression<Func<TEntity, TProperty?>> selector) where TEntity : class
        {
            DbCommandStrategy.Instance.LoadRuntimeCache<TEntity>(connection);
