...
namespace Forget.Tests.PostgreSql
{
    ...
    /// real <c>ON CONFLICT</c> behavior, real array binding for <c>= ANY(...)</c>.
    /// <para>
    /// All tests share one container and table (started once by <see cref="PostgreSqlFixture"/>) and stay isolated
    ...
    public class CrudIntegrationTests : IClassFixture<PostgreSqlFixture>
    {
        ...
        public CrudIntegrationTests(PostgreSqlFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        [Fact]
        public async Task GetAllAsync_CollectionContainsFilter_UsesEqualsAnyAgainstRealArrayParameter()
        {
        ...
        [Fact]
        public async Task UpsertAsync_InsertsWhenMissingThenUpdatesOnConflict()
        {
