...
{
    /// <summary>
    /// Proves every CLR type in <see cref="TypeMatrixRow"/> survives a real MySql round trip through the
    ...
    /// </para>
    /// </summary>
    public class TypeMatrixIntegrationTests : IClassFixture<MySqlFixture>
    {
        private readonly MySqlFixture _fixture;

        public TypeMatrixIntegrationTests(MySqlFixture fixture)
        {
            _fixture = fixture;
        }
